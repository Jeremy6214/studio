...
import { Activity, BarChart3, BookOpenCheck, MessageSquareText, BrainCircuit } from "lucide-react";
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Card className="shadow-lg hover:shadow-primary/30 transition-all duration-300 bg-card hover:scale-105 group">
          <CardHeader className="border-b border-border/50 pb-4">
            <CardTitle className="flex items-center text-xl text-foreground group-hover:text-primary transition-colors">
              <Activity className="mr-3 h-6 w-6 text-primary group-hover:techno-glow-primary" />
              Actividad Reciente
            </CardTitle>
        ...
        <Card className="shadow-lg hover:shadow-secondary/30 transition-all duration-300 bg-card hover:scale-105 group">
          <CardHeader className="border-b border-border/50 pb-4">
            <CardTitle className="flex items-center text-xl text-foreground group-hover:text-secondary transition-colors">
              <BarChart3 className="mr-3 h-6 w-6 text-secondary group-hover:techno-glow-secondary" />
              Tu Progreso
            </CardTitle>
        ...
        <Card className="shadow-lg hover:shadow-primary/30 transition-all duration-300 bg-card hover:scale-105 group row-span-1 md:row-span-2 flex flex-col">
          <CardHeader className="border-b border-border/50 pb-4">
            <CardTitle className="flex items-center text-xl text-foreground group-hover:text-primary transition-colors">
             <MessageSquareText className="mr-3 h-6 w-6 text-primary group-hover:techno-glow-primary" />
              Foros Activos
            </CardTitle>
        ...
        <Card className="shadow-lg hover:shadow-primary/30 transition-all duration-300 bg-card hover:scale-105 group md:col-span-2">
           <CardHeader className="border-b border-border/50 pb-4">
            <CardTitle className="flex items-center text-xl text-foreground group-hover:text-primary transition-colors">
              <BrainCircuit className="mr-3 h-6 w-6 text-primary group-hover:techno-glow-primary" />
              Asistente IA Nova
            </CardTitle>
      ...
      <Card className="shadow-lg bg-card hover:shadow-secondary/30 transition-all duration-300 hover:scale-105 group">
        <CardHeader className="border-b border-border/50 pb-4">
          <CardTitle className="flex items-center text-xl text-foreground group-hover:text-secondary transition-colors">
            <BookOpenCheck className="mr-3 h-6 w-6 text-secondary group-hover:techno-glow-secondary" />
